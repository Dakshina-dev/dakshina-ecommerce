...
const Product = () => {
  ...
  return (
   <div>
    <div className='grid grid-col-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 p-5 justify-center items-center mx-auto lg:px-20 container my-10'>
    {products.map((data)=>{
      return(
        <div className='w-72 h-[520px] border border-black flex flex-col items-center justify-between p-5' key={data.id}>
