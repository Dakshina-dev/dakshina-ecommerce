...
const Product = () => {
  ...
  return (
   <div>
    <h2 className='text-2xl text-blue-600 px-10 py-5 font-semibold'>Top Discounted Products <br /><span className='text-base font-normal text-gray-600'>( Discount more than 10% )</span></h2>
    <div className='flex gap-5 p-5 lg:px-20 overflow-auto'>
    {products.filter((data)=>data.discountPercentage > 10)
    .map((data)=>{
      return(
